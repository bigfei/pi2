...
alias rvlc="nohup /usr/bin/cvlc v4l2:///dev/video0:chroma=h264:width=1920:height=1080 :input-slave=\"alsa://hw:1,0\" --sout '#duplicate{dst=\"transcode{acodec=mp2a,ab=32}:rtp{sdp=rtsp://:8554/live}\", dst=\"transcode{acodec=mp2a,channels=1,ab=32}:rtp{sdp=rtsp://:8554/live_audio}\", select=\"novideo\",dst=\"rtp{sdp=rtsp://:8554/live_video}\", select=\"noaudio\"' &"
